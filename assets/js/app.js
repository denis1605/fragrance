...
(0, _jquery2.default)(document).ready(function () {
    ...
    var centerMap = { lat: 48.79691354, lng: 2.34764099 };
    ...
    var styles = [{
        ...
        stylers: [{ hue: "#d4c9e4" }, { saturation: -60 }]
    }, {

        featureType: "road",
        stylers: [{ hue: "#d4c9e4" }, { saturation: -20 }]
    }];
...
;(function () {
    ...
    var popup = document.getElementById('ba-popup'),
        btn = document.getElementById("ba-btn"),
